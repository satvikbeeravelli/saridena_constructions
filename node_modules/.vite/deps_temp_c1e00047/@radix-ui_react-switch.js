...
// node_modules/@radix-ui/react-switch/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
...
var useLayoutEffect22 = (globalThis == null ? void 0 : globalThis.document) ? React4.useLayoutEffect : () => {
};
...
function createSlot(ownerName) {
  ...
  const Slot2 = React9.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime2.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React9.isValidElement(newElement) ? React9.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Switch = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    const [button, setButton] = React11.useState(null);
...
var SwitchThumb = React11.forwardRef(
  (props, forwardedRef) => {
...
var SwitchBubbleInput = React11.forwardRef(
  ({
    __scopeSwitch,
    control,
    checked,
